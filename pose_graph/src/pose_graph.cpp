...
void PoseGraph::addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop)
{
    ...
    if (SAVE_LOOP_PATH)
    {
        ...
        ofstream foutC("/home/lihao/dataset/SLAM/EuRoC/tra/V1_01/HAWP-PL-VINS/tum_fast_plvins_loop.txt", ios::app);
        ...
        ofstream foutC1("/home/lihao/dataset/SLAM/EuRoC/tra/V1_01/HAWP-PL-VINS/ours.txt", ios::app);
        foutC1.setf(ios::fixed, ios::floatfield);
        foutC1.precision(0);
        foutC1 << cur_kf->time_stamp * 1e9<< " ";
        foutC1.precision(5);
        foutC1 << P.x() << " "
              << P.y() << " "
              << P.z() << " "
...
//        printf("path p: %f, %f, %f\n",  P.x(),  P.z(),  P.y() );
        ...
        if (SAVE_LOOP_PATH)
        {
            ...
            //       << endl;
            // loop_path_file.close();
        ofstream foutC("/home/lihao/dataset/SLAM/EuRoC/tra/V1_01/HAWP-PL-VINS/tum_fast_plvio_loop.txt", ios::app);
        foutC.setf(ios::fixed, ios::floatfield);
        foutC.precision(9);
        foutC << (*it)->time_stamp<< " ";
        foutC.precision(5);
