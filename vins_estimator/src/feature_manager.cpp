...
double FeatureManager::reprojection_error_3( Vector4d obs, Matrix3d Rwc, Vector3d twc, Vector6d line_w ) {
    ...
    Vector3d cross3d;
    cross3d=vc.cross(vc2);

    // ROS_WARN("error:%f\n",error);
    return 1 - cross3d.norm();

}

double FeatureManager::reprojection_error_2( Vector4d obs, Matrix3d Rwc, Vector3d twc, Vector6d line_w ) {
